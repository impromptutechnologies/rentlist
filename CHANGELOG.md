...
- [add] Add French and Spanish translations for Rentlist
...
allowed), translations files (Saunatime is changed to Rentlist), and it also adds
...
- [change] Change the logo, marketplace color and favicons from Saunatime to Rentlist.
