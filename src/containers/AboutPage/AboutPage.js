          ...
          <div className={css.contentWrapper}>
            ...
            <div className={css.contentMain}>
              ...
              <p>
                ...
                from Rentlist, you can together create just the right class for you.
              </p>
              ...
              <h3 id="contact" className={css.subtitle}>
                Create your own marketplace like Rentlist
              </h3>
              <p>
                Rentlist is brought to you by{' '}
